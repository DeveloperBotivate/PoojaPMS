            ...
            {isHardRock && (
              <div className="space-y-1">
                ...
                <input
                  ...
                  placeholder="Enter"
                  autoFocus
                  className="w-[160px] md:w-[200px] border border-emerald-400 rounded px-2 py-1 focus:outline-none focus:ring-2 focus:ring-emerald-500 text-[12px] md:text-[13px] h-[30px] md:h-[34px]"
                />
              </div>
            )}
          </div>
